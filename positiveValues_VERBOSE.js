...
// Increased from (y1_max = 2206) to (y1_range_max = 2434)
y1_range_max = global_dtick_ratio * y1_dtick
// Stayed the same from (y2_max = 365.24) to (y2_range_max = 365.24)
...
const plotlyComponent = Plotly.newPlot( yourDiv, data, layout, config )
